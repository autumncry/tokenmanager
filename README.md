...
- 静态项目主页源码位于 [site/index.html](site/index.html)，用于 GitHub Pages 或任意静态托管。
...
项目主页源码：[site/index.html](site/index.html)。
...
- Static product homepage source in [site/index.html](site/index.html) for GitHub Pages or any static host.
...
Product homepage source: [site/index.html](site/index.html).
